...
#### Getting familiar with GNU debugger (gdb)
...
3. Fix the next program so that it computes correctly the surface area and volume of a sphere given a radius.
...
2. Compile the programs using the `-g` switch, e.g. `g++ -g .cpp -o`
3. Invoke gdb.
